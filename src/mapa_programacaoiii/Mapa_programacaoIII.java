...
public class Mapa_programacaoIII {
       ...
       public static void main(String[] args) {
           ...
           reserva.getList().add(new Hospede(1,"Romario","rua manoel aquino 224", 32));
           reserva.getList().add(new Hospede(2,"Laura","rua manoel aquino 224", 35));
           reserva.getList().add(new Hospede(3,"Arthur","rua manoel aquino 224", 10));
           reserva.getList().add(new Hospede(4,"Debora","rua manoel aquino 224", 1));
